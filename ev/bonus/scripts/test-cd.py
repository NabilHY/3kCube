...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2026/08/26 19:21:00 by nhayoun           #+#    #+#              #
#    Updated: 2026/08/26 19:21:00 by nhayoun          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILE_PATH =  f"{os.path.expanduser("~")}/instra/bonus/confs/app/deployment.yml"
...
def main() -> None:
    ...
    global FILE_PATH
    FILE_PATH = f"{os.path.expanduser('~')}/{args.repo}/bonus/confs/app/deployment.yml"
